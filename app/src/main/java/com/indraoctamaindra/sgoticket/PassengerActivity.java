...
public class PassengerActivity extends Activity {
    ...
    public void __init(){
        ...
        out = DefinedDialog.CreateProgressDialog(PassengerActivity.this, null, "Loading ...");
        ...
        mBtnListAdapter = new BtnPassengerAdapter(PassengerActivity.this,arrButton);
        ...
        mBtnPassengerListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent i = new Intent(PassengerActivity.this,PopupPassengerActivity.class);
                 ...
                 try {
                     ...
                     UrlHit.post(getBaseContext(), urlUpdatePassenger, params, new TextHttpResponseHandler() {
                         ...
                         public void onFailure(int i, Header[] headers, String s, Throwable throwable) {
                             ...
                             AlertDialog.Builder builder1 = new AlertDialog.Builder(PassengerActivity.this);
                         ...
                         public void onSuccess(int i, Header[] headers, String s) {
                             ...
                             try {
                                 ...
                                 if(jObj.getString("error_code").equals("0000")) {
                                     ...
                                     String admin_amount = "";
                                     Integer total_admin = Integer.parseInt(objData.getString("admin_agent_total"));
                                     Integer total_tax   = Integer.parseInt(objData.getString("tax_total"));
                                     Integer discount_total = Integer.parseInt(objData.getString("discount_total"));
                                     Integer fee_total = Integer.parseInt(objData.getString("fee_total"));
                                     Integer ssr_total = Integer.parseInt(objData.getString("ssr_total"));
                                     Integer insurance_total = Integer.parseInt(objData.getString("insurance_total"));

                                     Integer admin_amount_int = total_admin + total_tax + fee_total + ssr_total + insurance_total - discount_total;
                                     admin_amount = admin_amount_int.toString();


                                     //total amount session
                                     tinydb.putString("total_amount", objData.getString("total").toString());
                                     //biaya admin
                                     tinydb.putString("admin_amount", admin_amount);
                                     //basic amount
                                     tinydb.putString("basic_amount", objData.getString("basic_fare"));
                                     //variable
                                     ...
                                     Intent intentinquiry = new Intent(PassengerActivity.this, PaymentmenuActivity.class);
