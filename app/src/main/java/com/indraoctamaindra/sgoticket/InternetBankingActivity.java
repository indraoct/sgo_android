...
import com.indraoctamaindra.library.Currency;
...
public class InternetBankingActivity extends Activity {
    ProgressDialog out;
    Spinner bankname;
    ...
    private String url_bankbillerIB = ParamConst.UrlBankBillerIB;
    ...
    private class DownloadJSON extends AsyncTask<Void,Void,Void>{
        ...
        protected Void doInBackground(Void... params) {
            ...
            jsonobject = JSONfunctions
                    .getJSONfromURL(url_bankbillerIB);
        ...
        protected void onPostExecute(Void args) {
            ...
            out = DefinedDialog.CreateProgressDialog(InternetBankingActivity.this, null, "Loading Internet Banking...");
            out.dismiss();
            ...
            // Spinner adapter
            bankname
                    .setAdapter(new ArrayAdapter<String>(InternetBankingActivity.this,
                                ...
                                btnProses.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        if(bank_code.equals("")){
                                            ...
                                            AlertDialog.Builder builder1 = new AlertDialog.Builder(InternetBankingActivity.this);
                                                    ...
                                                    builder1.setPositiveButton("Kembali",
                                                            new DialogInterface.OnClickListener() {
                                                                public void onClick(DialogInterface dialog, int id) {
                                                                    ...
                                                                    Intent intent = new Intent(InternetBankingActivity.this, PaymentmenuActivity.class);
                                                ...
                                                public void onSuccess(int i, Header[] headers, String s) {
                                                    ...
                                                    try {
                                                        ...
                                                        if (error_code.equals("0000")) {
                                                            ...
                                                            Intent intent = new Intent(InternetBankingActivity.this, PaymentwebActivity.class);
                                                            startActivity(intent);
                        ...
                        public void onNothingSelected(AdapterView<?> arg0) {
                            ...
                            btnProses.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    String product_code_rodex = tinydb.getString("product_code");
                                    String order_id = tinydb.getString("order_id");
                                    final String bank_code = bank.get(0).get_bank_code();
                                    final String product_code = bank.get(0).get_product_code();
                                    final String tx_id = tinydb.getString("tx_id");
                                    String amount = tinydb.getString("total_amount");
                                    ...
                                    if(bank_code.equals("")){
                                        ...
                                        params.put("tx_id", tx_id);
                                        params.put("amount", amount);
                                        params.put("product_h2h", bank.get(0).get_product_h2h());
                                        params.put("product_type", bank.get(0).get_product_type());
