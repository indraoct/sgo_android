...
/**
 * Created by Indra Octama on 7/18/2015.
 */
public class OnewaylistAdapter extends BaseAdapter {
    ...
    public OnewaylistAdapter(Activity context,   List<Map<String,String>> list) {
        mContext = context;
        mList = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View v = convertView;
        OnewayListViewHolder viewHolder;
        if (convertView == null) {
            LayoutInflater li = (LayoutInflater) mContext
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            v = li.inflate(R.layout.list_schedule, null);
            viewHolder = new OnewayListViewHolder(v);
            v.setTag(viewHolder);
        } else {
            viewHolder = (OnewayListViewHolder) v.getTag();
        }
...
class OnewayListViewHolder {
    ...
    public OnewayListViewHolder(View base) {
